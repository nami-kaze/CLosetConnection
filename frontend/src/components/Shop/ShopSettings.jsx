                ...
                >
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2"> Name(you want to give to your shop): </label>
                        </div>
                        <input
                            type="name"
                    ...
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2">Your Shop Address</label>
                        </div>
                        <input
                            type="name"
                    ...
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2">Your Shop Phone Number</label>
                        </div>
                        <input
                            type="number"
                    ...
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2">Your Shop Zip Code</label>
                        </div>
                        <input
                            type="number"
